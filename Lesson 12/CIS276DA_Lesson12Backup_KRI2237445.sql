...
--
-- Temporary view structure for view `open_items`
--

DROP TABLE IF EXISTS `open_items`;
/*!50001 DROP VIEW IF EXISTS `open_items`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `open_items` AS SELECT 
 1 AS `vendor_name`,
 1 AS `invoice_number`,
 1 AS `invoice_total`,
 1 AS `balance_due`*/;
...
--
-- Temporary view structure for view `open_items_summary`
--

DROP TABLE IF EXISTS `open_items_summary`;
/*!50001 DROP VIEW IF EXISTS `open_items_summary`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `open_items_summary` AS SELECT 
 1 AS `vendor_name`,
 1 AS `open_item_count`,
 1 AS `open_item_total`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vendor_address`
--

DROP TABLE IF EXISTS `vendor_address`;
/*!50001 DROP VIEW IF EXISTS `vendor_address`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vendor_address` AS SELECT 
 1 AS `vendor_id`,
 1 AS `vendor_address1`,
 1 AS `vendor_address2`,
 1 AS `vendor_city`,
 1 AS `vendor_state`,
 1 AS `vendor_zip_code`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `vendors` (
  ...
  KEY `vendors_zip_code_ix` (`vendor_zip_code`),
...
--
-- Final view structure for view `open_item`
--
...
/*!50001 VIEW `open_item` AS select `vendors`.`vendor_name` AS `vendor_name`,`invoices`.`invoice_number` AS `invoice_number`,`invoices`.`invoice_total` AS `invoice_total`,((`invoices`.`invoice_total` - `invoices`.`payment_total`) - `invoices`.`credit_total`) AS `balance_due` from (`vendors` join `invoices` on((`vendors`.`vendor_id` = `invoices`.`vendor_id`))) where (((`invoices`.`invoice_total` - `invoices`.`payment_total`) - `invoices`.`credit_total`) > 0) order by `vendors`.`vendor_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `open_items`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `open_items` AS select `vendors`.`vendor_name` AS `vendor_name`,`invoices`.`invoice_number` AS `invoice_number`,`invoices`.`invoice_total` AS `invoice_total`,((`invoices`.`invoice_total` - `invoices`.`payment_total`) - `invoices`.`credit_total`) AS `balance_due` from (`vendors` join `invoices` on((`vendors`.`vendor_id` = `invoices`.`vendor_id`))) where (((`invoices`.`invoice_total` - `invoices`.`payment_total`) - `invoices`.`credit_total`) > 0) order by `vendors`.`vendor_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `open_items_summary`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `open_items_summary` AS select `vendors`.`vendor_name` AS `vendor_name`,count(0) AS `open_item_count`,sum(((`invoices`.`invoice_total` - `invoices`.`credit_total`) - `invoices`.`payment_total`)) AS `open_item_total` from (`vendors` join `invoices` on((`vendors`.`vendor_id` = `invoices`.`vendor_id`))) where (((`invoices`.`invoice_total` - `invoices`.`credit_total`) - `invoices`.`payment_total`) > 0) group by `vendors`.`vendor_name` order by `open_item_total` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vendor_address`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vendor_address` AS select `vendors`.`vendor_id` AS `vendor_id`,`vendors`.`vendor_address1` AS `vendor_address1`,`vendors`.`vendor_address2` AS `vendor_address2`,`vendors`.`vendor_city` AS `vendor_city`,`vendors`.`vendor_state` AS `vendor_state`,`vendors`.`vendor_zip_code` AS `vendor_zip_code` from `vendors` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-11-15 10:25:31
